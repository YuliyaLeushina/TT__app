(() => {
  ...
  function p(e = {}, t = {}) {
    Object.keys(t).forEach((s) => {
      void 0 === e[s]
        ? (e[s] = t[s])
        : d(t[s]) && d(e[s]) && Object.keys(t[s]).length > 0 && p(e[s], t[s]);
    });
  }
  e.select = new (class {
  ...
  const y = {
    ...
    is: function (e) {
      ...
      if ("string" == typeof e) {
        ...
        for (n = b(e), l = 0; l < n.length; l += 1) if (n[l] === i) return !0;
        return !1;
      }
      if (e === s) return i === s;
      if (e === t) return i === t;
      ...
      for (let n = 0; n < p; n += 1) {
        ...
        if (
          ...
          if ("auto" === i.slidesPerView) {
            ...
            (E = (l - (i.slidesPerView - 1) * b) / i.slidesPerView),
              i.roundLengths && (E = Math.floor(E)),
      ...
      if (
        ...
        if (0 === t) r[e ? "scrollLeft" : "scrollTop"] = -d;
          ...
          if (!l.support.smoothScroll)
            return (
              M({ swiper: l, targetPosition: -d, side: e ? "left" : "top" }), !0
            );
    ...
    slideTo: function (e, t, s, i, n) {
      ...
      if (r.cssMode) {
        ...
        if (0 === t) {
          ...
          if (!l.support.smoothScroll)
            return (
              M({ swiper: l, targetPosition: s, side: e ? "left" : "top" }), !0
            );
  ...
  const V = {
    loopCreate: function () {
      ...
      for (let e = 0; e < r.length; e += 1)
        n.append(T(r[e].cloneNode(!0)).addClass(s.slideDuplicateClass));
      for (let e = a.length - 1; e >= 0; e -= 1)
  ...
  class re {
    constructor() {
      ...
      (l.__swiper__ = !0),
        (l.support = z()),
        (l.device = D({ userAgent: t.userAgent })),
        (l.browser = B()),
        (l.eventsListeners = {}),
